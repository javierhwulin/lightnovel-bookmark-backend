...
def create_novel(novel: schemas.LightNovelCreate, db: Session = Depends(get_db)) -> schemas.LightNovel:
    """
    Create a new novel
...
def update_novel(novel_id: int, novel: schemas.LightNovelUpdate, db: Session = Depends(get_db)) -> schemas.LightNovel:
    """
    Update a novel
...
def get_novel_chapters(novel_id: int, db: Session = Depends(get_db)) -> List[schemas.Chapter]:
    """
...
@router.post("/novels/{novel_id}/chapters", response_model=schemas.Chapter, status_code=201)
def create_chapter(novel_id: int, chapter: schemas.ChapterCreate, db: Session = Depends(get_db)) -> schemas.Chapter:
    """
...
def get_chapter(novel_id: int, chapter_id: int, db: Session = Depends(get_db)) -> schemas.Chapter:
    """
...
@router.patch("/novels/{novel_id}/chapters/{chapter_id}", response_model=schemas.Chapter)
def update_chapter(novel_id: int, chapter_id: int, chapter: schemas.ChapterUpdate, db: Session = Depends(get_db)) -> schemas.Chapter:
    """
    Update a chapter
...
def delete_chapter(novel_id: int, chapter_id: int, db: Session = Depends(get_db)) -> None:
    """
    Delete a chapter
