...
def create_demo_slime_novel(db: Session) -> LightNovel:
    ...
    existing_novel = db.query(LightNovel).filter(
        LightNovel.title == "Tensei Shitara Slime Datta Ken (WN)"
    ).first()
    ...
    sample_chapters = [
        ...
        {"ch": 2, "title": "Coexistence with Monsters", "url": "https://example.com/ch2"},
        {"ch": 3, "title": "Battle with the Direwolves", "url": "https://example.com/ch3"},
        ...
        {"ch": 7, "title": "Kaijin and the Magistrate", "url": "https://example.com/ch7"},
...
def create_demo_overlord_novel(db: Session) -> LightNovel:
    ...
    sample_chapters = [
        {"ch": 1, "title": "The End and the Beginning", "url": "https://example.com/overlord-ch1"},
        {"ch": 2, "title": "Floor Guardians", "url": "https://example.com/overlord-ch2"},
        {"ch": 3, "title": "Battle of Carne Village", "url": "https://example.com/overlord-ch3"},
        {"ch": 4, "title": "Ruler of Death", "url": "https://example.com/overlord-ch4"},
        {"ch": 5, "title": "Two Adventurers", "url": "https://example.com/overlord-ch5"},
        {"ch": 6, "title": "Journey", "url": "https://example.com/overlord-ch6"},
        {"ch": 7, "title": "Wise King of the Forest", "url": "https://example.com/overlord-ch7"},
        {"ch": 8, "title": "Twin Swords", "url": "https://example.com/overlord-ch8"},
        {"ch": 9, "title": "Dark Warrior", "url": "https://example.com/overlord-ch9"},
        {"ch": 10, "title": "The Bloody Valkyrie", "url": "https://example.com/overlord-ch10"},
    ]
